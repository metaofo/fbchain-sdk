...
// SubmitParamChangeProposal submits the proposal to change the params on FbChain
...
// SubmitCommunityPoolSpendProposal submits the proposal to spend the tokens from the community pool on FbChain
