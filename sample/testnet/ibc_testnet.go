...
func main() {
	...
	config, err := gosdk.NewClientConfig(rpcURL, "fbc-65", gosdk.BroadcastSync, "0.000001fibo", 450000,
	...
	res, err := cli.Ibc().Transfer(privateKey, "channel-2", addr, "0.1fibo", fees, "memo", client_types.Height{RevisionNumber: 1, RevisionHeight: 1000000})
	if err != nil {
		log.Fatal(err)
	}
